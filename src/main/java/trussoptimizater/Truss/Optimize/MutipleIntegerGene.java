...
public class MutipleIntegerGene extends NumberGene implements IPersistentRepresentation {
     ...
     * @since 2.0
     */
    public MutipleIntegerGene(final Configuration a_config, final int a_lowerBound, final int a_upperBound, final int a_significance)
            throws InvalidConfigurationException {
        super(a_config);
    ...
    protected Gene newGeneInternal() {
        try {
            MutipleIntegerGene result = new MutipleIntegerGene(getConfiguration(), m_lowerBounds,
