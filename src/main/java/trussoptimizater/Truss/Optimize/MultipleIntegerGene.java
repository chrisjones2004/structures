...
public class MultipleIntegerGene extends NumberGene implements IPersistentRepresentation {
    ...
    public MultipleIntegerGene() throws InvalidConfigurationException {
     ...
     * @since 3.0
     */
    public MultipleIntegerGene(final Configuration a_config)
            throws InvalidConfigurationException {
     ...
     * @since 2.0
     */
    public MultipleIntegerGene(final Configuration a_config, final int a_lowerBound, final int a_upperBound, final int a_significance)
            throws InvalidConfigurationException {
        super(a_config);
    ...
    protected Gene newGeneInternal() {
        try {
            MultipleIntegerGene result = new MultipleIntegerGene(getConfiguration(), m_lowerBounds,
        ...
        if (a_representation != null) {
            ...
            if (tokenizer.countTokens() != 4) {
                throw new UnsupportedRepresentationException(
                        "The format of the given persistent representation " + " is not recognized: it does not contain three tokens: " + a_representation);
            }
    ...
    public void setUpperBounds(int m_upperBounds) {
        this.m_upperBounds = m_upperBounds;
    }

    public void setLowerBounds(int m_lowerBounds) {
        this.m_lowerBounds = m_lowerBounds;
    }

    public void setSignificance(int m_significance) {
        this.m_significance = m_significance;
    }
}

/*class MultipleXIntegerGene extends MultipleIntegerGene{

    public MultipleXIntegerGene(final Configuration a_config, final int a_lowerBound, final int a_upperBound, final int a_significance)throws InvalidConfigurationException {
        super(a_config,a_lowerBound, a_upperBound, a_significance);
    }
}

class MultipleYIntegerGene extends MultipleIntegerGene{

    public MultipleYIntegerGene(final Configuration a_config, final int a_lowerBound, final int a_upperBound, final int a_significance)throws InvalidConfigurationException {
        super(a_config,a_lowerBound, a_upperBound, a_significance);
    }
}*/