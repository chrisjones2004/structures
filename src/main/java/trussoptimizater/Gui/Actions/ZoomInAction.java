...
public class ZoomInAction extends AbstractAction {
    ...
    public ZoomInAction(String text, String desc, GUI gui) {
        this(text,null,desc,gui);
    }

    public ZoomInAction(String text, ImageIcon icon, String desc, GUI gui) {
        this(text,icon,desc,null,gui);

    }

    public ZoomInAction(String text, ImageIcon icon, String desc, Integer mnemonic, GUI gui) {
        super(text, icon);
        this.gui= gui;
